...
<body>
   ...
   <div id="ToolBar">
       ...
       <div>标题:<input type="text" id="s_name" name="name">
            区域名称:<input type="text" id="s_tel" name="telephone">
            街道名称:<input type="text" id="s_startage" name="startAge">
            类型名称:<input type="text" id="s_endage" name="endAge">
           <a
